...
def main():
    ...
    speech = '\nTesting the algoriths for the case of infinite arms and unknow budget\n'
    speech = speech + 'My proposed algorithm vrs the algorithm of RCB_AIR\n'
